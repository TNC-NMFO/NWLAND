...
# redistribute the unavailable losses, based on the start area proportions
...
#delta_cult$lcat_code = delta_cult$reg_code * 100000 + delta_cult$own_code        #delta_cult$lcat_code = delta_cult$reg_code * 100000 + fresh_marsh_code * 100 + delta_cult$own_code
