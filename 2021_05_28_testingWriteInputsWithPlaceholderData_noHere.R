...
write_caland_inputs(
    c_file = "2021_05_14_carbon_input_nwland_testB3_devAll_noOcean.xls", # output file name
    inputs_dir = "2021_05_14_carbon_input_nwland_testB3_devAll_noOcean", # output file directory
    ...
    control_wildfire_lulcc_file = "individual_proposed_sims_control_lulcc_wildfire_aug2018.csv", #not used because following line is false
