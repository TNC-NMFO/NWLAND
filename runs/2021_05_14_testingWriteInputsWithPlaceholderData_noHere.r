...
write_caland_inputs(
    ...
    carbon_gis_files = c("~/GitHub/NWLAND/raw_data/soc_tpha_2017_stats.csv",
        ...
        "~/GitHub/NWLAND/raw_data/inventory_proto_ddc_tpha.csv", 
        "~/GitHub/NWLAND/raw_data/inventory_proto_dsc_tpha.csv", 
        "~/GitHub/NWLAND/raw_data/inventory_proto_ltc_tpha.csv", 
        "~/GitHub/NWLAND/raw_data/inventory_proto_usc_tpha.csv"),
    scen_tag = "protoA",
    start_year = 2016,
    end_year = 2050,
    CLIMATE = "HIST",
